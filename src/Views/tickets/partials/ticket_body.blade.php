            ...
            <h2 class="header">
                ...
                <span class="pull-right">
                    @if (!$ticket->completed_at)
                        {!! Form::open(['route' => 'travels.upload', 'files' => true, 'method' => 'POST', 'class' => 'dropzone dz-clickable']) !!}
                        <!--{!! Form::file('upload[]', array('multiple'=>true)) !!}-->
                        <div class="dz-message" data-dz-message><span>Datei hochladen</span></div>
